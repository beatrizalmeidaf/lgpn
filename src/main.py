...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default=".",
                        help="Caminho para o diretório de saída para salvar modelos e resultados")
...
def set_seed(seed):
    """
    Seta a seed para reprodutibilidade
    """
...
def main():
    ...
    if args.result_path:
        ...
        final_result_path = os.path.join(args.output_dir, args.result_path.format(
            str(args.way) + "-way_" + str(args.shot) + "-shot_" + args.dataset))

        directory = os.path.dirname(final_result_path)
        ...
        with open(final_result_path, "a", newline="") as f:
