...
def reidx_y(args, YS, YQ):
    """
    Mapeia os rótulos das classes no conjunto de suporte e no conjunto de consulta para um intervalo contínuo começando em 0.
    """
...
def del_tensor_ele(arr, index):
    """
    Deleta o elemento em 'index' do tensor 1D 'arr' e retorna o tensor resultante.
    """
    arr1 = arr[0:index]
    arr2 = arr[index + 1:]
...
def pre_calculate(train_data, net, args, state):
    """
    Pre-calcula a matriz de similaridade entre as representações das classes e a matriz de probabilidade para amostragem baseada em probabilidade.
    """
...
class SerialSampler():
    """
    Um amostrador que gera episódios de tarefas de few-shot learning.
    """
    ...
    def get_sample(self, classes, data):
        """
        Obtém exemplos de suporte e consulta para as classes fornecidas.
        """
    ...
    def get_epoch(self, sampled_classes):
        """
        Gera episódios de tarefas de few-shot learning.
        """
...
def task_sampler(data, args, classes_sample_p=None):
    """
    Amostra classes para um episódio de few-shot learning.
    """
